...
/* ZCB subset, where ZCB is a subset of ZC*  */
{"c.lbu",     0,  INSN_CLASS_ZCB,  "Ct,CZb(Cs)",  MATCH_C_LBU,  MASK_C_LBU, match_opcode, 0 },
{"c.lhu",     0,  INSN_CLASS_ZCB,  "Ct,CZh(Cs)",  MATCH_C_LHU,  MASK_C_LHU, match_opcode, 0 },
{"c.lh",      0,  INSN_CLASS_ZCB,  "Ct,CZh(Cs)",  MATCH_C_LH,  MASK_C_LH, match_opcode, 0 },
{"c.sb",      0,  INSN_CLASS_ZCB,  "Ct,CZb(Cs)",  MATCH_C_SB,  MASK_C_SB, match_opcode, 0 },
{"c.sh",      0,  INSN_CLASS_ZCB,  "Ct,CZh(Cs)",  MATCH_C_SH,  MASK_C_SH, match_opcode, 0 },
{"c.sext.b",  0,  INSN_CLASS_ZCB,  "CZc",  MATCH_C_SEXT_B, MASK_C_SEXT_B, match_opcode, 0 },
{"c.sext.h",  0,  INSN_CLASS_ZCB,  "CZc",  MATCH_C_SEXT_H, MASK_C_SEXT_H, match_opcode, 0 },
{"c.zext.b",  0,  INSN_CLASS_ZCB,  "CZc",  MATCH_C_ZEXT_B, MASK_C_ZEXT_B, match_opcode, 0 },
{"c.zext.h",  0,  INSN_CLASS_ZCB,  "CZc",  MATCH_C_ZEXT_H, MASK_C_ZEXT_H, match_opcode, 0 },
{"c.zext.w",  64, INSN_CLASS_ZCB,  "CZc",  MATCH_C_ZEXT_W, MASK_C_ZEXT_W, match_opcode, 0 },
{"c.not",     0,  INSN_CLASS_ZCB,  "CZc",  MATCH_C_NOT, MASK_C_NOT, match_opcode, 0 },
{"c.mul",     0,  INSN_CLASS_ZCB,  "CZc,Ct",  MATCH_C_NOT, MASK_C_NOT, match_opcode, 0 },
